      ...
      >
        ...
        >
          ...
          {showCloseButton && (
            <button
            onClick={onClose}
            className="fixed top-4 left-4 z-[100] text-muted-foreground hover:text-foreground rounded-full p-2 bg-background/80 backdrop-blur-sm opacity-80 transition-colors shadow-md hover:bg-background/100"
            aria-label="Close"
          >
            <X className="h-5 w-5" />
          </button>
